...
<!DOCTYPE html>
<html>
  <body class="antialiased sans-serif bg-gray-100" style="background-color: #FAFAF4 ; margin: 0;">
  ...
  <a class="active" href="meetings.php"> Meetings</a>
  ...
  <script defer src="https://unpkg.com/alpinejs@3.10.2/dist/cdn.min.js"></script>
    <link href="/src/StylesMeetings.css" rel="stylesheet" />
 ...
 <body>
  ...
  <header style="display: flex; justify-content: center; align-items: center;">
      <a href= "http://t.me/MrMeetBot"><img src="/images/logo.png" width="150" height="180"></a>

</header>


<h2 style="display: flex; justify-content: center; align-items: center; font-family: 'Quicksand', sans-serif;"> </h2>
<br>
	...
	<script>
		...
		function app() {
          ...
          for ($ObjectiveNo = 1; $ObjectiveNo <= 3; $ObjectiveNo += 1) 
          {
            ...
            {
              $date = 'MyObjectivesDate';
              $date .= (string)$ObjectiveNo;
              $date = $user_data[$date];
              ...
              if ($ObjectiveNo == 1)
              {
                echo 'event_theme: "red" ';
              } 
              elseif ($ObjectiveNo == 2)
              {
                echo 'event_theme: "yellow" ';
              }
              else
              {
                echo 'event_theme: "green" ';
              }
              echo '},';
              echo ' ';
            }
